@AssetsLiability @Investment
Feature: validation of Assets and Liability Functionality

  @AssetsLiability_Positive
  Scenario: TC_001_Post request for Assets and Liability positive scenario
    ...
    When I post the request with "AssetsLiability" payload
  ...
  Scenario: TC_002_Post request for Assets and Liability without Gateway AuthToken Negative
    Given I set up request specification
      | HeaderName   | HeaderValue              |
      | Content-Type | application/json         |
      | gatewayname  | https://stg.minty.co.in/ |
  ...
  Scenario: TC_003_Post request for Assets and Liability  without Gateway Name Negative
    Given I set up request specification
      | HeaderName       | HeaderValue                                                                                                                                                      |
      | Content-Type     | application/json                                                                                                                                                 |
      | gatewayauthtoken | eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJnYXRld2F5bmFtZSI6Imh0dHBzOi8vc3RnLm1pbnR5LmNvLmluLyIsImV4cCI6MTY5NDMyMjgxN30.GajK6Khkwc-oU5r7G8hW--uMoFKIzGAs1TEBOBS35Q0 |
  ...
  Scenario: TC_004_Post request for Assets and Liability  without Gateway Name and AuthToken Negative
    Given I set up request specification
      | HeaderName   | HeaderValue      |
      | Content-Type | application/json |
    When I post the request with "AssetsLiability" payload
  ...
  Scenario: TC_005_Post request for Assets and Liability  wrong Gateway name Negative
    Given I set up request specification
      | HeaderName       | HeaderValue                                                                                                                                                      |
      | Content-Type     | application/json                                                                                                                                                 |
  ...
  Scenario: TC_006_Post request for Assets and Liability  wrong Gateway AuthToken Negative
    Given I set up request specification
      | HeaderName       | HeaderValue                                                                                                                      |
      | Content-Type     | application/json                                                                                                                 |
      | gatewayname      | https://stg.minty                                                                                                                |
