package com.Fintoo.bdd.common.hooks;
	...
	public void before(Scenario scenario) throws Exception {
		...
		if (str_Execution_TYPE.equalsIgnoreCase("Web_UI")) {
			...
			try {
				...
				browserfactory.setBrowser(str_BrowserType.toLowerCase());
	...
	public void after(Scenario scenario) throws Exception {
		...
		if (str_Execution_TYPE.equalsIgnoreCase("Web_UI")) {
			...
			if (scenario.isFailed()) {
				...
				passedTests.add(scenario.getName());
				//DriverFactory.getInstance().getMobileDriver().close();
			}
			DriverFactory.getInstance().getMobileDriver().terminateApp("com.financialhospital.admin.finh");
			 System.out.println("---Close App---");
			 DriverFactory.getInstance().getMobileDriver().activateApp("com.financialhospital.admin.finh");
		     System.out.println("---Open App---");
