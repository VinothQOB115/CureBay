...
@CucumberOptions(features = { "@target/Mobile_rerun.txt" }, glue = { "com/Fintoo/bdd/Mobile/step_definitions",
		"com/Fintoo/bdd/common/hooks" }, tags = "@Khulke", plugin = { "pretty",
				"html:target/site/cucumber-pretty/cucumberMobile.html", "json:target/cucumber/cucumber.json",
