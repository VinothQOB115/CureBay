...
@CucumberOptions(features = { "src/test/java/com/Fintoo/api/bdd/feature" }, glue = {

		"com/Fintoo/common/bdd/hooks", "com/Fintoo/api/bdd/step_definitions" }, tags = "@riskcovry", plugin = {
				"pretty", "html:target/site/cucumber-pretty/cucumber_api.html", "json:target/cucumber/cucumber_api.json",
"io.qameta.allure.cucumber7jvm.AllureCucumber7Jvm","rerun:target/api_rerun.txt"}, monochrome = true, publish = true, dryRun = false)
//
